...
- `.github/dependabot.yml`: weekly updates for Go modules, npm, and GitHub Actions
- CodeQL (Go): **enabled** — scans root CLI and `tools/probe-convert/` on push/PR/weekly
- Secret scanning with push protection: **enabled**
- Private vulnerability reporting: **enabled**
- Branch protection on `main`: force-push blocked, PR reviews required, CLA check enforced
